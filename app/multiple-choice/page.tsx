    ...
    <>
      <main className="w-[360px] h-[720px] border border-gray-300 p-4">
        <div>
          ...
          {/* Question heading */}
          <div className="mb-2">On {Utils.getFormattedDate(0)}, ________</div>
          {/* Question */}
          <div className="font-serif text-2xl h-[380px] overflow-y-auto">
...
const Progress: React.FC<{ answers: Answers }> = ({ answers }) => {
  return (
    <div className="mb-6 flex gap-x-5 relative w-fit">
      {answers.map((answer, index) => {
        return (
